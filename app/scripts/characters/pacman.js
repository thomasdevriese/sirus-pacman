class Pacman {
  ...
  reset() {
    ...
    this.pacmanArrow.style.backgroundImage = 'url(build/assets/graphics/'
  ...
  setSpriteSheet(direction) {
    this.animationTarget.style.backgroundImage = 'url(build/assets/graphics/'
  ...
  prepDeathAnimation() {
    ...
    this.animationTarget.style.backgroundImage = 'url(build/assets/'
